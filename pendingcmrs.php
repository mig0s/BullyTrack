...
$getcmrs = $mysqli->prepare("SELECT cmr_id, course_code, cmr_timestamp from cmr where status='approved' and dlt_comment is NULL and `cmr_timestamp` >= DATE_SUB(DATE(now()), INTERVAL 14 DAY);");
$getcmrs->execute();
